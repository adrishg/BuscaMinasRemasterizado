...
import buscaminasjava.clases.Celda;
...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSpinner3.setModel(new javax.swing.SpinnerNumberModel(5, 3, 10, 1));

        jSpinner1.setModel(new javax.swing.SpinnerNumberModel(5, 3, 10, 1));

        jSpinner2.setModel(new javax.swing.SpinnerNumberModel(5, 3, 10, 1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jPanel2.setLayout(new java.awt.GridLayout((int)jSpinner1.getValue(), (int)jSpinner2.getValue()));
    ...
    public void cargar(){
        ...
        int minasx[]= coordenadasRandom(minas, filas);
        int minasy[]= coordenadasRandom(minas,columnas);
       
        for(int i=0; i<filas; i++){
            for(int j=0; j<columnas; j++){
                this.celda[i][j]=new Celda(i,j); //0=mina, 1=numero, 2= vacio
                this.celda[i][j].setTipoCelda(randomNumber());
    ...
    public int randomNumber(){
        ...
        int num =(int)(rd.nextDouble()*2);
        return num+1;
    }
    
    public int[] coordenadasRandom (int cantidadMinas, int extra){
        Random rd = new Random();
        int b[]=new int[cantidadMinas];
        int cont=0;
        boolean v;
        boolean cero=false;
        while(cont<cantidadMinas)
        {
            int numero=(int)(rd.nextDouble()*extra);
            v= true;
